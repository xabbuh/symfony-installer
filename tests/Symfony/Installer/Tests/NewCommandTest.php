...
class NewCommandTest extends CommandTest
{
    ...
    {
        return array(
            'patch-version-too-high' => array('2.3.100', 'Symfony version should be 2\.N\.M, where N = 0\.\.9 and M = 0\.\.99'),
            'missing-patch-version' => array('2.3', 'Symfony version should be 2\.N\.M, where N = 0\.\.9 and M = 0\.\.99'),
